...
//type SysAPI struct {
//	ID         int64  `gorm:"primary_key"`
//	Service    string `gorm:"column:service;type:varchar(80);comment:'api接口服务'" json:"service"`
//	Method     string `gorm:"column:method;type:varchar(80);comment:'api接口名称'" json:"method"`
//	ApiExplain string `gorm:"column:api_explain;type:varchar(200);comment:'说明'" json:"api_explain"`
//}
//
////Srv接口管理
//type SysSrv struct {
...
//	Service    string `gorm:"column:service;type:varchar(80);comment:'api接口服务'" json:"service"`
//	Method     string `gorm:"column:method;type:varchar(80);comment:'api接口名称'" json:"method"`
//	SrvExplain string `gorm:"column:srv_explain;type:varchar(200);comment:'说明'" json:"srv_explain"`
//}
//
////SysMenu 菜单管理
//type SysMenu struct {
