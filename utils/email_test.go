...
type EmailConfig struct {
	EmailType   EmailType `jsonos:"emailType"`
	UserName    string    `jsonos:"userName"`
	Password    string    `jsonos:"password"`
	Bcc         []string  `jsonos:"bcc"`
	Cc          []string  `jsonos:"cc"`
	To          []string  `jsonos:"to"`
	Subject     string    `jsonos:"subject"`
	Text        string    `jsonos:"text"`        // Plaintext message (optional)
	HTML        string    `jsonos:"html"`        // Html message (optional)
	AttachFiles []string  `jsonos:"attachFiles"` //附件
}
